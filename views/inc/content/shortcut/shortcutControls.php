...
<?
	switch($targetType) {
		case 'page':
		case 'video':
			echo "<li><a class='shortcutSettings' data-id='$contentID' data-type='$targetType' href='#'><i class='fa fa-window-maximize fa-flip-vertical'></i></a></li>";
			break;
		case 'gallery':
			echo "<li><a href='$path/edit'><i class='fa fa-window-maximize fa-flip-vertical'></i></a></li>";
			break;
	}
?>
