<div id="addGalImagesModal" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class='addImageDropzone dropzone row'></div>
			</div>
			...
			<div class="modal-footer">
				<div class='row'>
					...
					<div class='col-sm-4'>
						...
						<button type="button" id='submitImages' class="btn btn-primary" disabled>Upload</button>
					</div>
				</div>
			</div>
		</div>
